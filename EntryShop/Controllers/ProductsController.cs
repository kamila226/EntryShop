...
namespace EntryShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            List<ProductData> products = await _context.Products
               .Select(pr => new ProductData
               {
                   ID = pr.ID,
                   Title = pr.Title,
                   Code = pr.Code,
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditPost(int id, [Bind("ID,Code,Title,Price")] Product product)
        {
            if (id != product.ID)
            {
                return NotFound();
